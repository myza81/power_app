...
def scheme_col_sorted(
    ...
    """
    Version 2: DataFrame-only function with decorator handling Series conversion.
    This keeps the core logic cleaner.
    """
    col_scheme = ls_column

    # 1. Determine the primary column if a set is provided
